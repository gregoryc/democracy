...
FOUNDATIONAL_LIB_NONNULL
FOUNDATIONAL_LIB_NOTHROW
FOUNDATIONAL_LIB_FUNC size_t filter_(void *source, size_t source_size, size_t elem_size, void *destination, size_t dest_size, int (*condition)(void *))
{
