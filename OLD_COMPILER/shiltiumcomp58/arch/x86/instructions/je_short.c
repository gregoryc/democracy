...
u dac_get_length_of_je_short(void) {
	return 2;
}

void dac_append_je_short(DataAndCode* cr dac, const schar displacement) {
	...
	ARRAY_INDEX_ASSIGN(ARROW(dac, start_of_code), ARROW(dac, current_instruction_offset)) = (uchar)116;
