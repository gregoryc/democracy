...
#include "x86_instructions.h"
...
#if SIXTY_FOUR_BIT
	u dac_get_length_of_add_deref_register_as_qword_reg64(const Register64 register1) {
	...
	void dac_append_add_deref_register_as_qword_reg64(DataAndCode* cr dac, const Register64 register1, const Register64 register2) {
		assert_comparison(dac, !=, NULL, DataAndCode*, void*);
		
		dac_append_deref_register_as_qword_reg64(dac, register1, register2, 1
		#if DEBUG
			, "add qword["
		#endif
		);
